...
int main(int argc, char *argv[])
{
    ...
    {
        // NSString
        NSString *myStr1 = [[NSString alloc] initWithCString:"Lord of The Rings" encoding:NSUTF8StringEncoding];
        NSString *myStr2 = [NSString stringWithCString:"Dune" encoding:NSUTF8StringEncoding];  
        NSString *combine = [NSString stringWithFormat:@"%@ is a great book and %@ is also a great book", myStr1, myStr2];
        NSLog(combine);
        ...
        NSLog(@"%@, %@, %@, %@, %@, %@, %@, %@, %@", theLetterZ, fortyTwo, fortyTwoUnsigned, fortyTwoLong, fortyTwoLongLong, piFloat, piDouble, yesNumber, noNumber);
        ...
        NSDictionary *someDictionary2  =  [NSDictionary dictionaryWithObjectsAndKeys:
            @42, @"key1",
            @"Some string", @"key2",
            myMutantArray, @"key3",
            myStr1,  @"key4",
