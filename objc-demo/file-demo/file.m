...
int main(int argc, char *argv[])
{
    @autoreleasepool
    {
        ...
        if ([fileManager contentsEqualAtPath:@"/tmp/file1.txt" andPath:@"/tmp/file2.txt"] == YES) {
            NSLog(@"File contents match");
        }

        // copyItemAtPath 复制一个文件
        if ([fileManager copyItemAtPath:@"/tmp/file1.txt" toPath:@"/tmp/file2.txt" error:nil] == YES){
        ...
        NSFileHandle *fileHandle = [NSFileHandle fileHandleForWritingAtPath:@"/tmp/tmp2.txt"];
        // 内容追加到文件末尾
